...
public class OrderManagerController {
	...
	public void init() {
		...
		order1.setItems(Arrays.asList(new ItemEntity("Item_1__Order_1"), new ItemEntity("Item_2__Order_1"),
	...
	public String getOrder(Model model, @PathVariable long orderId) {
		OrderEntity order = (orderRepository.findById(orderId)).orElse(new OrderEntity("Not Found 404"));
